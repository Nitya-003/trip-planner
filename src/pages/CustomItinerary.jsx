...
console.log('All env vars:', import.meta.env); // Vite
// or
console.log('All env vars:', process.env); // CRA


// const genAI = new GoogleGenerativeAI(import.meta.env.VITE_GEMINI_API_KEY);
const genAI = new GoogleGenerativeAI(process.env.REACT_APP_GEMINI_API_KEY);

console.log('Gemini API Key loaded:', process.env.REACT_APP_GEMINI_API_KEY ? 'Yes' : 'No');
